...
I started seriously preparing my applications well before the deadlines. Most of the visible work, including writing statements, polishing my CV, and requesting recommendation letters, happened during the fall, but much of the important work began much earlier through research, conversations with advisors, and narrowing down the kinds of problems I wanted to work on.

My rough timeline looked like this:

* **Spring and early summer:** I started building a list of research areas, faculty, and programs. This stage involved much more reading than writing.
* **Summer:** I spoke with advisors and other people who knew the US system, reduced the initial list, and began thinking about the story connecting my previous work to the research I wanted to do next.
* **Early fall:** I drafted my statement of purpose, updated my CV, contacted recommenders, and created accounts in what felt like an endless collection of application portals.
* **Late fall:** I tailored statements, checked program-specific requirements, submitted applications, and repeatedly discovered one more short essay or form that I had overlooked.
* **Winter:** Interview invitations, rejections, silence, and a great deal of refreshing email.
* **Spring:** Offers, visit days, conversations with potential advisors and students, and the final decision.

Looking back, the applications themselves were only a small part of the overall process. One practical recommendation is to make a spreadsheet early. Mine became the external memory for the entire process. At minimum, I would track deadlines, program requirements, faculty of interest, whether those faculty expected to take students, recommendation-letter status, application fees, and any program-specific essays. The details are individually small, but there are too many to keep reliably in your head.
...
* Did the department encourage the kind of work I wanted to pursue?

I gradually developed a filtering process of sorts for potential PIs. Beyond reading their papers, I looked closely at how they presented their labs. Did the website showcase students and their work, or did it focus almost entirely on the PI? Could I learn where former students went? What did the site suggest about the lab's culture, personality, and values?
...
I also tried to apply only to places I could honestly imagine attending. Adding a program is expensive in time, money, and attention, and it creates work for recommenders as well. A so-called safety program is not useful if you already know you would decline the offer.
...
* What did I contribute or learn in those experiences?
* Why is this particular program a sensible place for the next step?
...
For direct-admit programs, however, contacting the PI can be crucial. In that case, try to establish a real connection rather than sending a generic message. Mention a talk or seminar you attended, a paper you read as part of your work on a specific problem, or another concrete reason their research relates to yours. The goal is to show why you are writing to that particular person.
...
* Which faculty would you like to work with?
...
After submitting applications, there is remarkably little you can do except wait. Some schools respond quickly, while others remain silent for months. Interview invitations arrive at different times, departments follow different timelines, and faculty availability changes. Silence is difficult not to interpret, even though it often means very little.

If I could give one piece of advice, it would simply be to make plans that have nothing to do with admissions. Continue your research, spend time with friends, exercise, travel, or do anything that keeps your life moving forward while decisions slowly arrive.

---

## Visit days

I could not attend visit days in person because of the war with Iran. This made an already difficult decision more complicated because visit days are often the best opportunity to experience a department's culture, meet potential advisors and lab members, and imagine everyday life there. In hindsight, I should have insisted on more interaction over Zoom. At the time, however, I was understandably preoccupied with the situation itself and did not have much capacity to advocate for a more complete virtual experience.

If attending in person is not possible, ask the program to help recreate the important parts remotely. A few extra conversations cannot replace a visit, but they can provide context that is difficult to get from websites or formal interviews. If I were doing this again, I would request meetings with potential advisors, students in their labs, students who had considered several of the same advisors, and people living in the city with partners or families. Each group answers different questions.

---

## Choosing where to go

I eventually found myself deciding between several programs that I genuinely would have been excited to attend. Research fit was still important, but by that stage I had already spent months researching potential advisors. I had deliberately applied only to places where I could imagine doing meaningful work with people I respected. By the time I had to choose, all of my options were good ones in that regard.

That made the decision much more difficult. Rankings were not especially useful, and research fit alone did not separate the choices clearly. I found myself thinking more seriously about the life surrounding the PhD:

* Where did I want to live for the next five or six years?
* Where could my partner also be happy and build a fulfilling life?
* What would our everyday life look like outside the university?
* Which place offered the community and environment we wanted during such a significant period of our lives?

These questions were not secondary to the academic decision. A PhD is long, and the place you live and the happiness of the people sharing that life with you matter enormously. It helped to separate questions with factual answers from questions of preference. Funding guarantees, degree requirements, and housing costs can be investigated. Whether I wanted to live in a particular city, whether my partner could be happy there, and which community felt right were judgments we had to make together. No ranking could make those decisions for us. My final choice reflected both the researcher I hope to become and the life my partner and I hope to build over the next several years.
...
* [Megan Le's PhD admissions retrospective](https://www.megankle.com/posts/phd_admissions/)
* [How to email a PI](https://loonylabs.org/2021/08/03/how-to-email-a-pi/), from Loony Labs
...
Do not spend the admissions cycle refreshing Reddit or certain other websites that I will deliberately not name, because I do not want to introduce anyone to them. Anonymous admissions forums are remarkably effective at turning a small amount of incomplete information into a large amount of anxiety.

You will find people comparing publication counts, interview dates, advisor replies, GPAs, and every other visible detail while knowing almost nothing about one another's research, letters, fit, subfield, or circumstances. A single stranger announcing an interview can quickly become "everyone has heard back except me." This is rarely a sound inference, but it is an excellent way to become paranoid.

If a website leaves you feeling informed and able to take useful action, it may be worth reading. If it mainly encourages you to compare yourself with anonymous applicants and repeatedly check for signals you cannot interpret, close it. I say this with the confidence of someone who did not always follow this advice.

If you're applying and have questions that aren't answered here, feel free to reach out. While I certainly don't have all the answers, I'm happy to share my experience if it might help someone else.
